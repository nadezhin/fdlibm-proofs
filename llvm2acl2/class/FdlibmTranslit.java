...
public class FdlibmTranslit {
    ...
    private static double U_DOUBLE = 0.0;
    private static int U_INT = 0;
    ...
    private static class Acos {
        ...
        private static final double pi      = 3.14159265358979311600e+00; /* 0x400921FB, 0x54442D18 */
        private static final double pio2_hi = 1.57079632679489655800e+00; /* 0x3FF921FB, 0x54442D18 */
        private static final double pio2_lo = 6.12323399573676603587e-17; /* 0x3C91A626, 0x33145C07 */
        private static final double pS0     = 1.66666666666666657415e-01; /* 0x3FC55555, 0x55555555 */
        private static final double pS1     = -3.25565818622400915405e-01; /* 0xBFD4D612, 0x03EB6F7D */
        private static final double pS2     = 2.01212532134862925881e-01; /* 0x3FC9C155, 0x0E884455 */
        private static final double pS3     = -4.00555345006794114027e-02; /* 0xBFA48228, 0xB5688F3B */
        private static final double pS4     = 7.91534994289814532176e-04; /* 0x3F49EFE0, 0x7501B288 */
        private static final double pS5     = 3.47933107596021167570e-05; /* 0x3F023DE1, 0x0DFDF709 */
        private static final double qS1     = -2.40339491173441421878e+00; /* 0xC0033A27, 0x1C8A2D4B */
        private static final double qS2     = 2.02094576023350569471e+00; /* 0x40002AE5, 0x9C598AC8 */
        private static final double qS3     = -6.88283971605453293030e-01; /* 0xBFE6066C, 0x1B8D0159 */
        private static final double qS4     = 7.70381505559019352791e-02; /* 0x3FB3B8C5, 0xB12E9282 */
    ...
    private static class Asin {
        ...
        private static final double pio2_hi = 1.57079632679489655800e+00; /* 0x3FF921FB, 0x54442D18 */
        private static final double pio2_lo = 6.12323399573676603587e-17; /* 0x3C91A626, 0x33145C07 */
        private static final double pio4_hi = 7.85398163397448278999e-01; /* 0x3FE921FB, 0x54442D18 */
    ...
    private static class Atan2 {
        ...
        static strictfp double compute(double y, double x) {
            ...
            if (k > 60) {
                ...
                z = Atan.compute(Fabs.compute(y / x));		/* safe to do y/x */
            }
            switch (m) {
                case 0:
                    return z;
    ...
    private static class Cos {
        ...
        static strictfp double compute(double x) {
            ...
            ix &= 0x7fffffff;
            if (ix <= 0x3fe921fb) {
                return KernelCos.compute(x, z);
            } /* cos(Inf or NaN) is NaN */ else if (ix >= 0x7ff00000) {
                return x - x;
    ...
    private static class KernelCos {
        ...
        private static final double one =  1.00000000000000000000e+00; /* 0x3FF00000, 0x00000000 */
        private static final double C1  =  4.16666666666666019037e-02; /* 0x3FA55555, 0x5555554C */
        private static final double C2  = -1.38888888888741095749e-03; /* 0xBF56C16C, 0x16C15177 */
        private static final double C3  =  2.48015872894767294178e-05; /* 0x3EFA01A0, 0x19CB1590 */
        private static final double C4  = -2.75573143513906633035e-07; /* 0xBE927E4F, 0x809C52AD */
        private static final double C5  =  2.08757232129817482790e-09; /* 0x3E21EE9E, 0xBDB4B1C4 */
        private static final double C6  = -1.13596475577881948265e-11; /* 0xBDA8FAE9, 0xBE8838D4 */
    ...
    private static class Cosh {
        ...
        static strictfp double compute(double x) {
            ...
            if (ix < 0x3fd62e43) {
                t = Expm1.compute(Fabs.compute(x));
                w = one + t;
                if (ix < 0x3c800000) {
            ...
            if (ix < 0x40862E42) {
                return half * Exp.compute(Fabs.compute(x));
            }

            /* |x| in [log(maxdouble), overflowthresold] */
            lx = __LO(x); //lx = *( (((*(unsigned*)&one)>>29)) + (unsigned*)&x);
            if (ix < 0x408633CE
                    || (ix == 0x408633ce) && (lx <= 0x8fb9f87dL)) {
 ...
 /* filter out huge and non-finite argument */
            ...
            if (k == 0) {
                ...
                t = one;
                if (k < 20) {
                    t = __HI(t, 0x3ff00000 - (0x200000 >> k));
                    /* t=1-2^-k */
                    y = t - (e - x);
                    y = __HI(y, __HI(y) + (k << 20));
                    /* add k to y's exponent */
     ...
     * > 2y use x1*x1 + (y*y + (x2*(x + x1))) for x*x + y*y where x1 = x with
     * lower 32 bits cleared, x2 = x - x1; else 2. if x <= 2y use t1*y1 + ((x-y)
     * * (x-y) + (t1*y2 + t2*y)) where t1 = 2x with lower 32 bits cleared, t2 =
     * 2x - t1, y1= y with lower 32 bits chopped, y2 = y - y1.
     *
     ...
     *
     * Accuracy: hypot(x,y) returns sqrt(x^2 + y^2) with error less than 1 ulps
    ...
    private static class Log10 {
        ...
        private static final double ivln10     =  4.34294481903251816668e-01; /* 0x3FDBCB7B, 0x1526E50E */
        private static final double log10_2hi  =  3.01029995663611771306e-01; /* 0x3FD34413, 0x509F6000 */
        private static final double log10_2lo  =  3.69423907715893078616e-13; /* 0x3D59FEF3, 0x11F12B36 */
        private static final double zero   =  0.0;
    ...
    private static class Log1p {
        ...
        private static final double Lp2 = 3.999999999940941908e-01; /* 3FD99999 9997FA04 */
        private static final double Lp3 = 2.857142874366239149e-01; /* 3FD24924 94229359 */
        private static final double Lp4 = 2.222219843214978396e-01; /* 3FCC71C5 1D8E78AF */
        private static final double Lp5 = 1.818357216161805012e-01; /* 3FC74664 96CB03DE */
        private static final double Lp6 = 1.531383769920937332e-01; /* 3FC39A09 D078C69F */
        private static final double Lp7 = 1.479819860511658591e-01; /* 3FC2F112 DF3E5244 */
        private static final double zero = 0.0;
        ...
        static strictfp double compute(double x) {
            ...
            if (k != 0) {
                ...
                hu &= 0x000fffff;
                if (hu < 0x6a09e) {
                    u = __HI(u, hu | 0x3ff00000);
                    /* normalize u */
                } else {
                    k += 1;
                    u = __HI(u, hu | 0x3fe00000);
                    /* normalize u/2 */
                    hu = (0x00100000 - hu) >> 2;
                }
                f = u - 1.0;
    ...
    private static class Pow {
        ...
        private static final double two53 =  9007199254740992.0; /* 0x43400000, 0x00000000 */
        private static final double huge  =  1.0e300;
        private static final double tiny  =  1.0e-300;
	/* poly coefs for (3/2)*(log(x)-2s-2/3*s**3 */
        private static final double L1  =  5.99999999999994648725e-01; /* 0x3FE33333, 0x33333303 */
...
//	i0 = ((*(int*)&one)>>29)^1; i1=1-i0;
	   ...
	   log(x) by x-x^2/2+x^3/3-x^4/4 */
            ...
            j += (n << 20);
            if ((j >> 20) <= 0) {
                z = Scalbn.compute(z, n);	/* subnormal output */
            } else {
                z = __HI(z, __HI(z) + (n << 20));
            }
            return s * z;
        }
    }
    ...
    private static class RemPio2 {
        ...
        private static final double zero =  0.00000000000000000000e+00; /* 0x00000000, 0x00000000 */
        private static final double half =  5.00000000000000000000e-01; /* 0x3FE00000, 0x00000000 */
        private static final double two24 =  1.67772160000000000000e+07; /* 0x41700000, 0x00000000 */
        private static final double invpio2 =  6.36619772367581382433e-01; /* 0x3FE45F30, 0x6DC9C883 */
        private static final double pio2_1  =  1.57079632673412561417e+00; /* 0x3FF921FB, 0x54400000 */
        private static final double pio2_1t =  6.07710050650619224932e-11; /* 0x3DD0B461, 0x1A626331 */
        private static final double pio2_2  =  6.07710050630396597660e-11; /* 0x3DD0B461, 0x1A600000 */
        private static final double pio2_2t =  2.02226624879595063154e-21; /* 0x3BA3198A, 0x2E037073 */
        private static final double pio2_3  =  2.02226624871116645580e-21; /* 0x3BA3198A, 0x2E000000 */
        private static final double pio2_3t =  8.47842766036889956997e-32; /* 0x397B839A, 0x252049C1 */
    ...
    private static class KernelRemPio2 {
        ...
        private static final double one    = 1.0;
        private static final double two24   =  1.67772160000000000000e+07; /* 0x41700000, 0x00000000 */
        private static final double twon24  =  5.96046447753906250000e-08; /* 0x3E700000, 0x00000000 */
            ...
            for (;;) {
                ...
                if (z == zero) {
                    ...
                    if (j == 0) {
                        ...
                        jz += k;
                        continue recompute;//goto recompute;
                    }
                }
                break recompute;
            }
        ...
        static strictfp double compute(double x, int n) {
            ...
            if (k <= -54) {
                if (n > 50000) /* in case integer overflow in n+k */ {
                    ...
                    return tiny * Copysign.compute(tiny, x); 	/*underflow*/
                }
            }
            k += 54;
            /* subnormal result */
    ...
    private static class Sin {
        ...
        static strictfp double compute(double x) {
            ...
            ix &= 0x7fffffff;
            if (ix <= 0x3fe921fb) {
                return KernelSin.compute(x, z, 0);
            } /* sin(Inf or NaN) is NaN */ else if (ix >= 0x7ff00000) {
                return x - x;
            } /* argument reduction needed */ else {
                n = RemPio2.compute(x, y);
                switch (n & 3) {
    ...
    private static class KernelSin {
        ...
        private static final double half =  5.00000000000000000000e-01; /* 0x3FE00000, 0x00000000 */
        private static final double S1  = -1.66666666666666324348e-01; /* 0xBFC55555, 0x55555549 */
        private static final double S2  =  8.33333333332248946124e-03; /* 0x3F811111, 0x1110F8A6 */
        private static final double S3  = -1.98412698298579493134e-04; /* 0xBF2A01A0, 0x19C161D5 */
        private static final double S4  =  2.75573137070700676789e-06; /* 0x3EC71DE3, 0x57B1FE7D */
        private static final double S5  = -2.50507602534068634195e-08; /* 0xBE5AE5E6, 0x8A2B9CEB */
        private static final double S6  =  1.58969099521155010221e-10; /* 0x3DE5D93A, 0x5ACFD57C */
    ...
    private static class Sinh {
        ...
        static strictfp double compute(double x) {
            ...
            if (ix < 0x40862E42) {
                return h * Exp.compute(Fabs.compute(x));
            }
    ...
    private static class Tan {
        ...
        static strictfp double compute(double x) {
            ...
            ix &= 0x7fffffff;
            if (ix <= 0x3fe921fb) {
                return KernelTan.compute(x, z, 1);
            } /* tan(Inf or NaN) is NaN */ else if (ix >= 0x7ff00000) {
                return x - x;		/* NaN */
            } /* argument reduction needed */ else {
                n = RemPio2.compute(x, y);
                return KernelTan.compute(y[0], y[1], 1 - ((n & 1) << 1));
                /*   1 -- n even
							-1 -- n odd */
            }
        }
    ...
    private static class KernelTan {
        ...
        private static final double xxx[] = {
...
/* pio4lo */     3.06161699786838301793e-17     /* 3C81A626, 33145C07 */
        ...
        private static final double one    = 1.00000000000000000000e+00; /* 3FF00000, 00000000 */
        private static final double pio4   = 7.85398163397448278999e-01; /* 3FE921FB, 54442D18 */
        private static final double pio4lo = 3.06161699786838301793e-17; /* 3C81A626, 33145C07 */
        private static final double T[] = xxx;
    ...
    private static class Tanh {
        ...
        static strictfp double compute(double x) {
            ...
            if (ix < 0x40360000) {
                ...
                if (ix >= 0x3ff00000) {
                    /* |x|>=1  */
                    t = Expm1.compute(two * Fabs.compute(x));
                    z = one - two / (t + two);
                } else {
                    t = Expm1.compute(-two * Fabs.compute(x));
                    z = -t / (t + two);
