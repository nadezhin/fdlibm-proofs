...
(defund @__ieee754_exp-%0 (mem %x)
  (b* (
    ...
    ((mv %y mem) (alloca-double-1 'y mem))
    ((mv %hi mem) (alloca-double-1 'hi mem))
    ((mv %lo mem) (alloca-double-1 'lo mem))
    ((mv %c mem) (alloca-double-1 'c mem))
    ((mv %t mem) (alloca-double-1 't mem))
    ((mv %k mem) (alloca-i32-1 'k mem))
    ((mv %xsb mem) (alloca-i32-1 'xsb mem))
