...
(defund @__ieee754_cosh-%82 (mem %1)
  (b* (
    (%83 (load-double %1 mem)))
  %83))

(defund @__ieee754_cosh-%81 (mem %1)
  (b* (
    (mem (store-double #x7FF0000000000000 %1 mem)))
  (@__ieee754_cosh-%82 mem %1)))

(defund @__ieee754_cosh-%71 (mem %t %w %1 %2)
  (b* (
    (%72 (load-double %2 mem))
    (%73 (@fabs %72))
    (%74 (fmul-double #x3fe0000000000000 %73))
    (%75 (@__ieee754_exp %74))
    (mem (store-double %75 %w mem))
    (%76 (load-double %w mem))
    (%77 (fmul-double #x3fe0000000000000 %76))
    (mem (store-double %77 %t mem))
    (%78 (load-double %t mem))
    (%79 (load-double %w mem))
    (%80 (fmul-double %78 %79))
    (mem (store-double %80 %1 mem)))
  (@__ieee754_cosh-%82 mem %1)))

(defund @__ieee754_cosh-%68 (mem %lx %t %w %1 %2)
  (b* (
    (%69 (load-i32 %lx mem))
...
(defund @__ieee754_cosh-%56 (mem %ix %lx %t %w %1 %2)
  (b* (
    ...
    (%58 (lshr-i32 %57 29))
    (%59 (bitcast-double*-to-i32* %2))
    (%60 (zext-i32-to-i64 %58))
    (%61 (getelementptr-i32 %59 %60))
    (%62 (load-i32 %61 mem))
    (mem (store-i32 %62 %lx mem))
    (%63 (load-i32 %ix mem))
...
(defund @__ieee754_cosh-%51 (mem %1 %2)
  (b* (
    ...
    (mem (store-double %55 %1 mem)))
  (@__ieee754_cosh-%82 mem %1)))

(defund @__ieee754_cosh-%48 (mem %ix %lx %t %w %1 %2)
  (b* (
    (%49 (load-i32 %ix mem))
...
(defund @__ieee754_cosh-%27 (mem %t %w %1)
  (b* (
    (%28 (load-double %t mem))
    (%29 (load-double %t mem))
    (%30 (fmul-double %28 %29))
    (%31 (load-double %w mem))
    (%32 (load-double %w mem))
...
(defund @__ieee754_cosh-%25 (mem %w %1)
  (b* (
    (%26 (load-double %w mem))
    (mem (store-double %26 %1 mem)))
  (@__ieee754_cosh-%82 mem %1)))

(defund @__ieee754_cosh-%17 (mem %ix %t %w %1 %2)
  (b* (
    (%18 (load-double %2 mem))
    (%19 (@fabs %18))
    (%20 (@expm1 %19))
    (mem (store-double %20 %t mem))
    (%21 (load-double %t mem))
    (%22 (fadd-double #x3ff0000000000000 %21))
    (mem (store-double %22 %w mem))
    (%23 (load-i32 %ix mem))
