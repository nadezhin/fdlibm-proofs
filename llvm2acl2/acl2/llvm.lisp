...
(defund load-var (var mem)
;  (m5::binding var mem))
  (g var mem))

(defund store-var (var words mem)
;  (m5::bind var words mem))
  (s var words mem))
